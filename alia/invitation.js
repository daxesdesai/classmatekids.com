 ...
 * For Alia's 10th Birthday Party
 */

// ============================================
// FIREBASE CONFIGURATION
// Shared Firebase project with Sara's and Ariana's invitations;
// data is scoped under a different EVENT_ID below.
// ============================================
...
const EVENT_ID = "alia-10th-birthday";

// Admin secret key
const ADMIN_SECRET = "alia2026admin";
...
function generateInviteUrl(inviteId) {
    const baseUrl = window.location.origin + '/alia/';
...
function renderGuestTable(invites, rsvps, views) {
    ...
    Object.entries(invites).forEach(([inviteId, invite]) => {
        ...
        const viewedStyle = view ? 'color: var(--slime-mint-dark);' : 'color: var(--slime-ink-soft); opacity: 0.6;';
...
function renderRsvpToggle() {
    ...
    if (currentRsvpClosed) {
        ...
        statusText.style.color = 'var(--slime-pink-dark)';
        ...
        statusText.style.color = 'var(--slime-mint-dark)';
